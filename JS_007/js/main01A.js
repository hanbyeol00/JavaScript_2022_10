 ...
 * DOMContentLoaded : 화면에 모든 요소가 다그려지면..
 */

document.addEventListener("DOMContentLoaded", () => {
  const btnRe = document.querySelector("div.btn_re");
  // span 의 개수가 많아서, class 를 모두 붙이기 번거롭다
  ...
  const lottoDisp = () => {
    ...
    /**
     * Math.random() 함수는
     * 0.0000 ~ 0.999999999999999 까지 범위에서
     * 임의 숫자 1개를 만들어 내는 기능
     *
     * 생성된 숫자에 10을 곱하면
     * 0 ~ 9.9999 범위에 수가 만들어진다
     *
     * 이 숫자를 Math.floor() 함수에게 전달하면
     * 0 ~ 9까지 범위의 정수를 만들어서 return한다
     */
    ...
    // test end
    /**
     * 1 ~ 45 까지 숫자가 저장된 nums 배열을 shuffle 해 보자
     */
    for (i = 0; i < 1000; i++) {
