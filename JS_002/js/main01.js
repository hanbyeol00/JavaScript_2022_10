...
/** 30 + 40 의 결과 : 70 이라고 표현하고 싶다
 * 문자열과 숫자를 + 하면 숫자가 문자열이 된다
 * 이 연산은
...
document.write("30 + 40 의 결과 : " + 30 + 40);
document.write("<br>");
...
/**
 * 30 + 40 = 70 의 원하는결과를 얻기 위하여
 * 먼저 숫다 30 + 40 의 연산을 괄호로 묶어
 * 연산 우선순위를 높여주면 된다
