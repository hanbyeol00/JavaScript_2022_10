...
but.addEventListener("click", () => {
  ...
  const sum1 = Number(txtNum1);
  const sum2 = Number(txtNum2);
  ...
  if (!txtNum1) {
    ...
    relt1.innerText = txtNum1 + " + " + txtNum2 + " = " + (sum1 + sum2);
    relt2.innerText = txtNum1 + " - " + txtNum2 + " = " + (sum1 - sum2);
    relt3.innerText = txtNum1 + " x " + txtNum2 + " = " + sum1 * sum2;
    relt4.innerText = txtNum1 + " ÷ " + txtNum2 + " = " + sum1 / sum2;
  }
});